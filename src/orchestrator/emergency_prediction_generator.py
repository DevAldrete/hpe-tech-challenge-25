...
class EmergencyGenerator:
    ...
    def __init__(
        ...
        simulated_minutes_per_tick: int = 30,  # Advance by 30 mins...
        tick_interval_seconds: float = 3.0,    # ...every 3 real-world seconds
    ) -> None:
        """
    ...
    async def start(self) -> None:
        ...
        self.running = True
        logger.info("predictive_generator_started", istart_sim_time=self.current_sim_time.isoformat())
    ...
    async def _generate_predictive_emergencies(self) -> None:
        ...
        recommendations = self.predictor.predict_current_risk(self.current_sim_time)
